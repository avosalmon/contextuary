...
const features = [
  {
    name: "Lookup",
    description:
      "Discover the meaning of words and phrases, taking into account the context they are used in. Get accurate meanings, pronunciations, tone, contextual translations, and helpful images, along with multiple example phrases for reinforcement.",
